...
global.ohsync = require("asyncawait/async");
global.ohwait = require("asyncawait/await");
...
global.bot = new Eris(`Bot ${config.token}`, {
	...
	firstShardID: Number(process.env.SHARD_ID),
	lastShardID: Number(process.env.SHARD_ID),
	maxShards: Number(process.env.MAX_SHARDS),
	gatewayVersion: 6,
	cleanContent: true
});
/* eslint-enable test */
